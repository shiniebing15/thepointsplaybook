  ...
  const DOMAIN_DATA = [
    ...
    },
    {
      ...
      tasks: [
        ...
        { name: 'Handling Multiple Major Purchases', points: 40, type: 'high', badge: 'MAJOR OPERATIONS' }
      ]
    },
    {
      id: 6,
      ...
      tasks: [
        ...
        { name: 'Notable Campaign Performance', points: 20, type: 'bonus', badge: 'PERFORMANCE BONUS', customLabel: 'Bonus Points' }
      ]
    },
    {
      id: 7,
      ...
      tasks: [
        ...
        { name: 'End-to-End PR Responsibility', points: 70, type: 'pinnacle', badge: 'FLAGSHIP PR LEAD', customLabel: 'Up to 70 Points' }
      ]
    },
    {
      id: 8,
      ...
      tasks: [
        ...
        { name: 'Conducting an Interview', points: 25, type: 'high' },
